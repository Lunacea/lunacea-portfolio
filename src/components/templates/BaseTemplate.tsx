        ...
        <div className="flex flex-col items-center justify-center min-h-screen px-4">
          <div className="text-center mb-12">
            <Link href="/" className="group">
              <h1 className="
                text-8xl md:text-9xl lg:text-[12rem] font-black leading-none
                mb-4 bg-gradient-to-r from-gray-300 via-purple-400 to-gray-300 bg-clip-text text-transparent
                hover:scale-105 transition-transform duration-500 cursor-pointer tracking-wider"
              >
                {AppConfig.name}
              </h1>
              <h2 className="
                text-xl md:text-2xl lg:text-3xl text-gray-300 tracking-wide
